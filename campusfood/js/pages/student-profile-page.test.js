...
/*
  These mock paths assume student-profile-page.js imports like this:

  import { sb } from '../../config/supabase.js';
  import { requireRole } from '../../shared/guards.js';
  import { logout } from '../../shared/session.js';

  If your page imports use ../config and ../shared instead, change these three
  mock paths to match the page imports exactly.
*/
